...
(function(root, factory) {
  ...
  $.raty = {
    ...
    single:       false,
    space:        true,
    starHalf:     '/transforma-petropolis-bit/img/avaliacoes/star-half.png',
    starOff:      '/transforma-petropolis-bit/img/avaliacoes/star-off.png',
    starOn:       '/transforma-petropolis-bit/img/avaliacoes/star-on.png',
    starType:     'img',
    target:       undefined,
    targetFormat: '{score}',
    targetKeep:   false,

...
<div class="form-group text-right">
    ...
    <?= $this->Html->link('<i class="fas fa-file-pdf"></i> Imprimir Ficha de Inscrição', ['action' => 'imprimir', $aluno->id, $aluno->codigo_acesso], ['target' => '_blank', 'class' => 'btn btn-default', 'escape' => false]); ?>
</div>

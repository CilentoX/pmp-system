...
<div class="dias_horarios">
    ...
    <ol style="list-style: none; padding: 0">
        <?php
        if ($curso->dias_horarios):
            $i = 0;
            ?>
            <?php foreach ($curso->dias_horarios as $d): ?>
            <li>
                <div class="row">
                    <div class="form-group col-md-4">
                        <?php echo $this->Form->control("dias_horarios.$i.dia_semana", ['label' => 'Dia da Semana', 'class' => 'form-control', 'options' => [0 => 'Domingo', 1 => 'Segunda', 2 => 'Terça', 3 => 'Quarta', 4 => 'Quinta', 5 => 'Sexta', 6 => 'Sábado'], 'empty' => 'Selecione >>>', 'required' => true]); ?>
                    </div>
                    <div class="form-group col-md-4">
                        <?php echo $this->Form->control("dias_horarios.$i.horario_inicio", ['type' => 'text', 'label' => 'Horário de Início', 'class' => 'form-control hora', 'required' => true]); ?>
                    </div>
                    <div class="form-group col-md-3">
                        <?php echo $this->Form->control("dias_horarios.$i.horario_fim", ['type' => 'text', 'label' => 'Horário de Término', 'class' => 'form-control hora', 'required' => true]); ?>
                    </div>
                    <div class="col-md-1">
                        <button class="pull-right btn btn-link btn-exc-dia" style="margin-top: 18px;">

    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <?php foreach ($cursos as $curso): ?>
            <tr>
                ...
                <td class="actions" style="min-width: 370px">
                    <?= $this->Html->link('<i class="far fa-address-card"></i> Matricular', ['controller' => 'cursos-alunos', 'action' => 'add', $curso->id], ['escape' => false, 'class' => 'btn btn-default', 'data-tooltip' => 'tooltip', 'title' => 'Matricular Aluno']) ?>
                    ...
                    <?= $this->Html->link('<i class="fas fa-pencil-alt"></i>', ['action' => 'edit', $curso->id], ['escape' => false, 'class' => 'btn btn-default', 'data-tooltip' => 'tooltip', 'title' => 'Editar']) ?>
                    <?= $this->Form->postLink('<i class="fas fa-trash-alt"></i>', ['action' => 'delete', $curso->id], ['escape' => false, 'class' => 'btn btn-default', 'confirm' => __('Deseja realmente excluir # {0}?', $curso->id), 'data-tooltip' => 'tooltip', 'title' => 'Excluir']) ?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
